        ...
        <Wrapper>
            <Layout>
                ...
                <section className="text-left my-5">
                    ...
                    <h6 className="black-text w-responsive mx-auto mb-4">
                        제 1 장 총칙
                    </h6>
                    <p className="grey-text w-responsive mx-auto">
                        제 1 조 (목적)
                        본 약관은 KKOBUK이 운영하는 웹 사이트 (http://kkobuk.tk/)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
                    </p>
                    <p className="grey-text w-responsive mx-auto">
                        제 2 조 (용어의 정의)
                    ...
                    <p className="grey-text w-responsive mx-auto">
                        제 12 조 (제품에 대한 사항)
                        회사와 재화 또는 용역(이하 “재화등”이라 합니다.)의 구매에 관한 계약을 체결한 회원은 재화등의 구매일 또는 재화등의 수령일로부터 7일 이내에 청약의 철회를 할 수 있습니다.
                        회원은 다음의 경우 위 1항의 청약철회를 할 수 없습니다.
                        1) 회원에게 책임 있는 사유로 재화등이 멸실 또는 훼손된 경우
                    ...
                    <p className="grey-text w-responsive mx-auto">
                        ...
                        사용자 자세 촬영은 거북목을 판단하기 위한 자료로만 활용되며, 따로 보관하지 않는다.
                    </p>
